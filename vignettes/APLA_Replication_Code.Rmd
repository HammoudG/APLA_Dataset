...
tm_shape(Map_APLA_Data) + tm_borders("black", lwd= .5) + 
  ...
  tm_scale_bar(width = 0.22, position = c(0.65, 0.08)) + tm_text("Country", size = "AREA") + tm_credits("Figure 1. Source: APLA Database", position = c( "left", 0.15))
